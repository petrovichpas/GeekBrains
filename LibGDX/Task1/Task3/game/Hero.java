...
public class Hero {
    ...
    public Hero(GameController gc) {
        ...
        this.hpView = 3;
        this.hitArea = new Circle(640, 360, 32);
        this.hitArea.setPosition(position);
        this.hitArea.setRadius(32.0f);
    }
    ...
    public void takeDamage(Asteroid asteroid) {
        hpView--;
        if (hpView <= 0) {
            System.out.println("GAME OVER"); // потом доделать вывод надписи на экран
        }
        velocity.add(asteroid.getVelocity());
    }
