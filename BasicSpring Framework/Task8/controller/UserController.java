...
import ru.geekbrains.springbootlesson.entity.User;
import ru.geekbrains.springbootlesson.repo.RoleRepository;
...
public class UserController {
    ...
    @GetMapping
    public String userList(Model model, @RequestParam(name = "minAge", required = false) Integer minAge,
        ...
        Page<User> userPage = userService.filterByAge(minAge, maxAge, username, PageRequest.of(page.orElse(1) - 1, size.orElse(5)));
