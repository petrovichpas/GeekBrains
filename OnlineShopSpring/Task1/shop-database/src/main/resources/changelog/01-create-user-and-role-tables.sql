create table products (id bigint not null auto_increment, title varchar(255) not null,
                       price decimal(19,2) not null, primary key (id)) engine=InnoDB;
GO

create table categories (id bigint not null auto_increment, name varchar(255) not null,
...
create table roles (id bigint not null auto_increment, name varchar(255) not null,
                    primary key (id)) engine=InnoDB;
GO

create table users (id bigint not null auto_increment, age integer, email varchar(255),
